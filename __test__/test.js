...
test("first found element level works as the base for the ast, typo in the middle", () => {
	expect( md.render("${toc}\n\n## Section\n\n# Probably a typo\n\n## Another Section") ).toBe(`<nav class="table-of-contents"><ol><li><a href="#section"> Section</a></li><li><a href="#probably-a-typo"> Probably a typo</a><ol><li><a href="#another-section"> Another Section</a></li></ol></li></ol></nav><h2 id="section"><a class="header-anchor" href="#section" aria-hidden="true">§</a> Section</h2>
...
test("unicode can be handled with uslug", () => {
	expect( umd.render("${toc}\n\n# 日本語") ).toBe('<nav class="table-of-contents"><ol><li><a href="#日本語"> 日本語</a></li></ol></nav><h1 id="日本語"><a class="header-anchor" href="#日本語" aria-hidden="true">§</a> 日本語</h1>\n');
});
